...
- **📑 Экспорт в PDF** — открывает окно с кнопками прямого скачивания PDF и печати
...
- **PDF** — открывает окно с кнопками прямого скачивания PDF и печати
...
- **jsPDF + html2canvas** — прямое скачивание PDF из браузера
- **Print API браузера** — альтернативный путь через диалог печати
...
- При прямом PDF-экспорте содержимое рендерится как изображение страницы (возможны отличия от печатного движка браузера)
